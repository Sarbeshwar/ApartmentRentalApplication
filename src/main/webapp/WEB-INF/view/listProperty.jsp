...
<body>
    ...
    <div class="max-w-lg mt-20">
        <form:form action="processProperty" modelAttribute="property" class="bg-white rounded px-10 pt-10 pb-10 mb-10" method="post">
		<table>
		<caption></caption>
		<th id="th">
		<tr>
				<td>ID: <form:input path="id" name="id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/></td>
			...
			<tr>
				<td colspan="2"><input type="submit" value="ADD PROPERTY" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4"/></td>
			</tr>
			</th>
		</table>
	</form:form>
