...
<head>
<title>VIEW-LISTED-PROPERTIES</title>
...
<body>
		...
		<div
			...
			<nav
				...
				<a class="mr-5 hover:text-gray-900"
					href="/AppartmentRental/ownerindexpage">ownerIndex</a> <a
					class="mr-5 hover:text-gray-900"
					href="/AppartmentRental/listproperty">listProperty</a>
			</nav>
		</div>
	</header>
	...
	<caption>Table</caption>
		<tr>
			<th id="id">ID</th>
			<th id="no_of_rows">No Of Rows</th>
			<th id="furnished_status">Furnished Status</th>
			<th id="location">Location</th>
			<th id="type_of_accomodity">Type Of Accommodation</th>
			<th id="lister_name">Lister's Name</th>
		</tr>
		<c:forEach var="property" items="${properties}">
			<tr>
				...
				<td>${property.type_of_accommodation}</td>
				<td>${property.lister_name}</td>
				<td><a href="/AppartmentRental/edit/${property.id}">UPDATE</a></td>
				<td><a href="/AppartmentRental/delete/${property.id}">DELETE</a></td>
			</tr>
		</c:forEach>
	</table>
