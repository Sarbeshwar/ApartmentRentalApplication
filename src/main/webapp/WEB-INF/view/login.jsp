...
<a class="mr-5 hover:text-gray-900" href="/AppartmentRental/">Home</a>
    ...
    <div class="max-w-lg mt-20">
		...
		<caption></caption>
			...
			<tr>
				<td>status:<form:input path="status" name="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"/></td>
