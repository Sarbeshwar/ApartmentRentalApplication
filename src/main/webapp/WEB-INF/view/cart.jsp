...
<body>
  ...
  <c:forEach var="pr" items="${sessionScope.cart}">
     ...
     <tr>
      ...
      <td>${pr.prop.id }</td>
      <td>${pr.prop.no_of_rooms}</td>
      <td>${pr.prop.furnished_status}</td>
      <td>${pr.prop.location}</td>
      <td>${pr.prop.type_of_accommodation}</td>
      <td>${pr.prop.lister_name}</td>
