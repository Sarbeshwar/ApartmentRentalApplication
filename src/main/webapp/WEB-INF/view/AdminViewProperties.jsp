		...
		<div
			...
			<a
				...
				<svg fill="none" stroke="currentColor" stroke-linecap="round"
                  ...
                  </svg> <span class="ml-3 text-xl">Admin View Properties</span>
			</a>
			<nav
...
<caption>TABLE</caption>
		<thead>
			<tr>
				<th id="id"> Id </th>
				<th id="furnished_status"> Furnished_Status </th>
				<th id="lister_name"> Lister_Name </th>
				<th id="location"> Location</th>
				<th id="no_of_rooms"> Number_of_Rooms </th>
				<th id="accomodity_type"> Type_of_Accomodity </th>
