...
<head>
<title>VIEW-PROPERTIES-OF-SEARCHED-USER</title>
...
<body>
	...
	<caption></caption>
	<th id="th">
		<form class="bg-white rounded px-10 pt-10 pb-10 mb-10" action="search" method="post">
			<div class="mb-4">
				<label class="block text-gray-700 text-sm font-bold mb-2" for="search">
					SEARCH </label> 
					<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
					id="search" name="search" type="text" value="${name}" readonly="true">
